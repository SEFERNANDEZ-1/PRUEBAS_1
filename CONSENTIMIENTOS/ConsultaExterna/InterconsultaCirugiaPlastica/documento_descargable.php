...
$sql = "SELECT firma, cedula, registro_p, nombre FROM cirugiaplastica WHERE cedula = '$especialista'";
...
<body>
    ...
    en <b>CIRUGIA PLASTICA</b> , quienes emiten su opinión sobre el caso. El médico especialista responde al solicitante emitiendo el juicio y las recomendaciones sobre
...
$pdf->render();
$pdf->stream("$fecha _ $cedula $cedulaNoAutoriza _ Cirugia Plastica.pdf", array("Attachment" => false));
