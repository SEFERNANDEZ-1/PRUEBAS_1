...
<body>
    ...
    $consultEspe = "SELECT cedula, firma, nombre, registro_p FROM  cirugiaplastica";
    ...
    <section class="form-register">
        <form action=documento_descargable.php method="POST" id='formulario' name="formulario">
            ...
            <center>
                <h1>Consentimiento Informado Cirugia Plastica</h1>
            </center>
            <center>
                <h1>AUTORIZADO</h1>
            </center>
            ...
            <div class="espacioEntreLinea">
                ...
                <p>
                    ...
                    especialistas en <b>CIRUGIA PLASTICA</b>, quienes emiten su opinión sobre el caso. El médico
