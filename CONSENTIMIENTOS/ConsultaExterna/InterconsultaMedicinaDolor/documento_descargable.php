...
$sql = "SELECT firma, cedula, registro_p, nombre FROM medicinadolor WHERE cedula = '$especialista'";
...
if ($autorizacion == "si" || $autorizacion == "SI") {
    ...
    $nombreEspecialistaNoAutoriza = "";
    $autorizacionNo = "";
} else if ($autorizacion == "no" || $autorizacion == "NO") {
    ...
    $nombreEspecialistaNoAutoriza = $row['nombre'];
...
<body>
    ...
    en <b>MEDICINA DEL DOLOR Y CUIDADO PALIATIVO </b> , quienes emiten su opinión sobre el caso. El médico especialista responde al solicitante emitiendo el juicio y las recomendaciones sobre
    la asistencia y el tratamiento a seguir respecto al problema consultado.<br>
    ...
    de las variables: biológicas, fisiológicas, sicológicas o sociales del usuario y/o paciente.<br><br>
    ...
    <b>AUTORIZAR:</b> <b><?php echo "$autorizacion" ?></b>

    <br><b>ALTERNATIVAS AL PROCEDIMIENTO:</b>
    <b></b>
    ...
    <table border="2">
        <tbody>
            ...
            <tr>
                <td>
                    <b>
                        <center><img src="<?php echo "$img" ?>" height="200" width="200" aling="center"></center>
                    </b>
                </td>
                <td>
                    <b>
    ...
    <p>
        A <b><?php echo "$nombreEspecialistaNoAutoriza" ?></b> y a la IPS DOLORMED S.A.S, con Nit. 900.442.930-6,
...
$pdf->render();
$pdf->stream("$fecha _ $cedula $cedulaNoAutoriza _ Medicina Del Dolor.pdf", array("Attachment" => false));
