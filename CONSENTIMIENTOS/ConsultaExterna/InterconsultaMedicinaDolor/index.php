...
<body>
    ...
    $consultEspe = "SELECT cedula, firma, nombre, registro_p FROM  medicinadolor";
    ...
    <section class="form-register">
        <form action=documento_descargable.php method="POST" id='formulario' name="formulario">
            ...
            <center>
                <h1>Consentimiento Informado Medicina Del Dolor y Cuidado Paliativo</h1>
            </center>
            ...
            <div class="espacioEntreLinea">
                ...
                <p>
                    ...
                    especialistas en <b>MEDICINA DEL DOLOR Y CUIDADO PALIATIVO</b>, quienes emiten su opinión sobre el caso. El médico
            ...
            A <select name="especilista" id="especilista" class="input" required>
                ...
                ?>
            </select> y a la IPS DOLORMED S.A.S, con Nit.
            900.442.930-6, para que me realicen la actividad,intervención,
            procedimiento o tratamiento que requiero.
            <table border="2">
                <tbody>
                    <tr>
                        <!--cuadro2  -->
                    ...
                    <tr>
                        <td>
                            <input type="text" name="NombrePaciente" id="NombrePaciente" class="input" autocomplete="off" placeholder="Nombre del Paciente">
                        </td>
                        <td>
