...
$sql = "SELECT firma, cedula, registro_p, nombre FROM ortopedia WHERE cedula = '$especialista'";
...
<body>
    ...
    en <b>ORTOPEDIA Y TRAUMATOLOGIA</b> , quienes emiten su opinión sobre el caso. El médico especialista responde al solicitante emitiendo el juicio y las recomendaciones sobre
...
$pdf->render();
$pdf->stream("$fecha _ $cedula $cedulaNoAutoriza _ Ortopedia.pdf", array("Attachment" => false));
