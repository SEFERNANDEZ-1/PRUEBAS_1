...
include_once 'conn.php';
	if (isset($_POST['nombre'])) {
		...
		if($nombre == ""){
			...
			$sql="INSERT INTO medicinadolor (cedula,firma,nombre,registro_p)VALUES('$cedula', '$img', '$nombre', '$registro_p')";
	...
	$sql="INSERT INTO dolormet_firma (nombre,firma, cedula)VALUES('$nombre', '$img', '$cedula')";
	$result = mysqli_query($connexion, $sql);
